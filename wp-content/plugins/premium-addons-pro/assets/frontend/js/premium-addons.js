(function ($) {
    ...
    $(window).on('elementor/frontend/init', function () {
        ...
        var PremiumUnfoldHandler = ModuleHandler.extend({
            ...
            bindEvents: function () {
                // Wait for the gallery widget to load before running the unfold functionality
                var self = this,
                    shouldWait = this.elements.$unfoldContentWrap.find('.elementor-widget-gallery').length;
                ...
                $elem
                    ...
                    .socialfeed({
                        twitter: {
                            ...
                            tweets: settings.data.tweets.slice(0, settings.limit),
        ...
        var PremiumMagicSectionHandler = function ($scope, $) {
            ...
            //Close Off Canvas when escape keyboard button is hit.
        ...
        var PremiumContentToggleHandler = function ($scope, $) {
            ...
            var sides = {};
            sides[0] = contentList.find('li[data-type="premium-content-toggle-monthly"]');
            sides[1] = contentList.find('li[data-type="premium-content-toggle-yearly"]');
            ...
            function hideItem(filter) {
                ...
                $scope.find('.premium-content-toggle__first-label, .premium-content-toggle__second-label').toggleClass('premium-content-toggle__active-text');
            }
        };
        ...
        var PremiumImageHotspotHandler = function ($scope, $) {
            ...
            hotspots.tooltipster({
                ...
                functionReady: function (origin, tooltipObj) {
                    ...
                    $(".tooltipster-box").addClass("tooltipster-box-" + settings.id + " premium-con-lq__" + settings.glass);
                    $(".tooltipster-arrow").addClass("tooltipster-arrow-" + settings.id);

                    if ('none' !== settings.glass) {
                        $(".tooltipster-box").addClass("premium-addons__v-hidden").css('transition', 'all 0.3s ease-in');
                        setTimeout(function () {
                            $(".tooltipster-box").removeClass("premium-addons__v-hidden");
                        }, 300);
                    }
