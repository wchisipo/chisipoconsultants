    ...
    $(window).on('elementor/frontend/init', function () {
        var PremiumHorizontalScrollHandler = elementorModules.frontend.handlers.Base.extend({
            ...
            bindEvents: function () {
                ...
                if ($('.premium-mscroll-yes').length > 0) {
        ...
        window.premiumHorizontalScroll = function ($scope, settings, controlSettings) {
            ...
            var self = this,
                ...
                $sectionsWrap = $scope.find('.premium-hscroll-sections-wrap'),
                id = settings.id,
            ...
            if (rtlMode) {
                ...
                // Make sure templates appears in same order, not reversed.
                $sectionsWrap.children().each(function (i, el) {
                    $sectionsWrap.prepend(el);
                });

                // Commented because this is used for opacity scroll effect which is hidden on RTL.
                // targetIndex = count - 1;
            }
            ...
            self.checkDisableOnOption = function () {
                ...
                if (disableOn.includes(elementorFrontend.getCurrentDeviceMode())) {
                    ...
                    $sectionsWrap.removeClass('premium-hscroll-sections-wrap premium-addons__v-hidden');
            ...
            self.init = function () {
                ...
                $sectionsWrap.removeClass('premium-addons__v-hidden');
                ...
                // if (snapScroll && settings.force_snap && document.body.scrollHeight > 3000 && $elem.offset().top > 500) {
                if (snapScroll && settings.force_snap) {
            ...
            self.checkRemoteAnchors = function () {
                ...
                var horSlideID = url.searchParams.get("slide"),
                    sectionID = url.searchParams.get("section");


                if (horSlideID)
                    self.checkAnchors(horSlideID);
            ...
            self.setScene = function () {
                ...
                timeline = gsap.timeline({
                    ...
                    scrollTrigger: {
                        ...
                        onToggle: function () {
                            isActive = $('.one-hscroll').length > 0 ? true : !isActive;
                        },
                    },
                });
            ...
            self.onScroll = function (event) {
                ...
                if ((isScrolling && null !== event) || $('.one-hscroll').length > 0)
                    self.preventDefault(event);
