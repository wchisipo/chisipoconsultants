(function ($) {
    $(window).on('elementor/frontend/init', function () {
        ...
        var PremiumSmartPostListingHandler = elementorModules.frontend.handlers.Base.extend({
            ...
            hideExtraItems: function () {
                ...
                if (isContainer) {
                    $extraItems.each(function (index, item) {
                        ...
                        $(item).closest('.elementor-widget-premium-grid-item').css({
                            visibility: 'hidden',
                            opacity: 0
                        });
                    });
                } else {
                    $parentCol = $parentCol.length < 1 ? $extraItems.closest('.elementor-top-column') : $parentCol;
            ...
            triggerElementorAnimation: function ($elements) {
                console.log('trigger animation');

                this.$element.find(".elementor-invisible").each(function (index, elem) {
            ...
            getPostsByAjax: function (shouldScroll) {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        nonce: PremiumSMLSettings.nonce,
                    },
                    beforeSend: function () {
                    ...
                    success: function (res) {
                        ...
                        _this.triggerElementorAnimation();
            ...
            reconstructFilterTabs: function () {
                ...
                if (deviceTabs > $visibleTabs.length) {
                    ...
                    for (var i = 0; i < itemsNo; i++) {
                        ...
                        var $clone = $($wrappedTabs[i]).removeClass('premium-smart-listing__wrapped-filter').clone(true, true);
                    ...
                    for (var i = 1; i <= itemsNo; i++) {
                        ...
                        var $clone = $($visibleTabs[$visibleTabs.length - i]).addClass('premium-smart-listing__wrapped-filter').clone(true, true);
