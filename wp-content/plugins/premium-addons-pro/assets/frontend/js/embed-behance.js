        ...
        function m(t, i) {
            ...
            switch (t) {
                ...
                case "title":
                    ...
                    break;
                case "publishedDate":
                    var siteLangBh = document.documentElement.lang || 'en';
                    1 == n.publishedDate && (s += '<div class="wrap-label">Published:</div>', s = '<div class="wrap-published-date-outer">' + (s += '<div class="wrap-value">' + moment(i.published_on * 1000).locale(siteLangBh).format('ddd MMM DD YYYY') + "</div>") + "</div>", p = 1);
                    break;
                case "projectUrl":
